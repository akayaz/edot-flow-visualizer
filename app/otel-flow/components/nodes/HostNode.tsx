  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-3">
        {/* OS Badge */}
        <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-amber-500/10 text-amber-400 text-xs font-medium">
          {data.os.toUpperCase()}
        </div>

        {/* IP Address */}
        {data.ipAddress && (
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-gray-700/50 text-gray-300 text-xs font-mono">
            {data.ipAddress}
          </div>
        )}
      </div>
